  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-bento-surface border border-bento-border rounded-2xl p-6 space-y-4 max-w-xl">
        <p className="text-xs text-bento-text-secondary">
          Pengaturan pemberitahuan usulan baru diaktifkan secara otomatis.
        </p>
      </div>
    </div>
  );
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-xs text-bento-text-secondary mt-1">
          Publikasikan hasil kajian, artikel kebudayaan, naskah riset, atau wawasan adat secara langsung ke portal publik <code className="text-purple-400">/artikel</code>.
        </p>
      </div>
