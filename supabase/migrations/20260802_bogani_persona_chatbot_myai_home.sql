-- ════════════════════════════════════════════════════════════════════════
-- Migration: Persona "Bogani AI" untuk field chatbot_myai_home (Lengkap & Menyatu)
-- ════════════════════════════════════════════════════════════════════════
...
1. Kamus Bahasa Mongondow & Frasa Pendek — indeks ribuan entri kata (dasar & berimbuhan) plus kartu kata unggulan (Bogani, Totabuan, Arai, Biontu, Inaton, Modayag) dan frasa percakapan harian.
