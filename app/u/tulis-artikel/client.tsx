  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok && data.success) {
        ...
        setError(data.error || "Gagal menerbitkan artikel. Silakan coba lagi.");
      }
    } catch (err: any) {
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        {success && (
          <div className="p-5 rounded-2xl bg-emerald-500/10 border border-emerald-500/30 text-emerald-300 text-sm font-bold flex items-center gap-3 animate-fade-in">
            ...
            <div>
              <p>Artikel Berhasil Diterbitkan! 🎉</p>
          ...
          <div className="space-y-2 bg-[#14151e] p-5 rounded-2xl border border-[#232536]">
            <div className="flex items-center justify-between">
              ...
              <span className="text-[11px] text-gray-400 flex items-center gap-1">
                <HelpCircle className="w-3.5 h-3.5 text-purple-400" /> Mendukung format Markdown (# Judul, **teks tebal**, list, quote)
              </span>
            </div>
...
## Sub Judul Artikel
Paragraf penjelas pembahasan sejarah atau adat budaya...

- Poin utama 1
- Poin utama 2

> Kutipan ungkapan adat Mongondow..."
          ...
          <div className="flex items-center justify-between pt-4 border-t border-[#212330]">
            ...
            >
              ...
              <span>{submitting ? "Menerbitkan..." : "Terbitkan Artikel Sekarang"}</span>
            </button>
          </div>
        </form>
      </div>
