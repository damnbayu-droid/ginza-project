...
export default function EcosystemPage() {
  const ecosystemItems = [
    ...
    },
    {
      ...
      url: '/kamus',
      domain: 'mongondowpedia.com/kamus',
      isReady: true,
      icon: Languages,
    ...
    },
    {
      ...
      url: '/#chat',
      domain: 'mongondowpedia.com/bogani-ai',
      isReady: true,
      icon: Bot,
    ...
    },
    {
      ...
      url: '#',
      domain: 'mongondowpedia.com/kuis',
      isReady: true,
      icon: Trophy,
    ...
    },
    {
      ...
      url: '#',
      domain: 'mongondowpedia.com/educational',
      isReady: true,
      icon: GraduationCap,
    ...
    },
    {
      ...
      url: '#',
      domain: 'mongondowpedia.com/seni-budaya',
      isReady: true,
      icon: Music,
    ...
    },
    {
      ...
      url: '#',
      domain: 'mongondowpedia.com/game-simulator',
      isReady: false,
      icon: Gamepad2,
